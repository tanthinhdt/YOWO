...
# cfg.TRAIN.RESUME_PATH = os.path.join(os.getcwd(), cfg.TRAIN.RESUME_PATH)
# cfg.WEIGHTS.BACKBONE_3D = os.path.join(os.getcwd(), cfg.WEIGHTS.BACKBONE_3D)
# cfg.WEIGHTS.BACKBONE_2D = os.path.join(os.getcwd(), cfg.WEIGHTS.BACKBONE_2D)
# cfg.LISTDATA.BASE_PTH = os.path.join(os.getcwd(), cfg.LISTDATA.BASE_PTH)
# cfg.LISTDATA.TRAIN_FILE = os.path.join(os.getcwd(), cfg.LISTDATA.TRAIN_FILE)
# cfg.LISTDATA.TEST_FILE = os.path.join(os.getcwd(), cfg.LISTDATA.TEST_FILE)
# cfg.LISTDATA.TEST_VIDEO_FILE = os.path.join(os.getcwd(), cfg.LISTDATA.TEST_VIDEO_FILE)
# cfg.BACKUP_DIR = os.path.join(os.getcwd(), cfg.BACKUP_DIR)
...
optimizer = torch.optim.Adam(
    parameters, lr=cfg.TRAIN.LEARNING_RATE, weight_decay=cfg.SOLVER.WEIGHT_DECAY
)
...
assert dataset in ['ava', 'ucf24', 'jhmdb21', 'vsl'], \
    "invalid dataset"
...
if dataset == "ava":
...
elif dataset in ["ucf24", "jhmdb21", "vsl"]:
    train_dataset = list_dataset.UCF_JHMDB_VSL_Dataset(
        cfg.LISTDATA.BASE_PTH,
        cfg.LISTDATA.TRAIN_FILE,
        dataset=dataset,
    ...
    test_dataset = list_dataset.UCF_JHMDB_VSL_Dataset(
        cfg.LISTDATA.BASE_PTH,
        cfg.LISTDATA.TEST_FILE,
        dataset=dataset,
        shape=(cfg.DATA.TRAIN_CROP_SIZE, cfg.DATA.TRAIN_CROP_SIZE),
        transform=transforms.Compose([transforms.ToTensor()]),
        train=False,
...
if cfg.TRAIN.EVALUATE:
    ...
    for epoch in range(cfg.TRAIN.BEGIN_EPOCH, cfg.TRAIN.END_EPOCH + 1):
        ...
        save_checkpoint(
            state, is_best, cfg.BACKUP_DIR, cfg.TRAIN.DATASET, cfg.DATA.NUM_FRAMES
        )
